...
let
  ...
  getDeps = drv: drv.buildPlugins ++ (map getDeps drv.erlangDeps);
  plugins = unique (ownPlugins ++ unique (flatten (map getDeps erlangDeps)));
  ...
  pkg = self: stdenv.mkDerivation (attrs // {
    ...
    propagatedBuildInputs = unique (erlangDeps ++ plugins);
