...
rec {
  ...
  */
  ...
  args: arguments merged into version-specific args, used mostly to customize dependencies;

  arguments passed to the generic-builder are overridable, used to enable/disable high-level OTP
